...
export interface UniV3ImmutablesInterface extends utils.Interface {
  functions: {
...
export interface UniV3Immutables extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: UniV3ImmutablesInterface;
