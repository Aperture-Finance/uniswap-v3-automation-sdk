...
export interface PancakeV3CallbackInterface extends utils.Interface {
  functions: {
...
export interface PancakeV3Callback extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: PancakeV3CallbackInterface;
