...
export interface IPancakeV3PoolDerivedStateInterface extends utils.Interface {
  functions: {
...
export interface IPancakeV3PoolDerivedState extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: IPancakeV3PoolDerivedStateInterface;
