...
export interface IPancakeV3PoolEventsInterface extends utils.Interface {
  functions: {};
...
export interface IPancakeV3PoolEvents extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: IPancakeV3PoolEventsInterface;
