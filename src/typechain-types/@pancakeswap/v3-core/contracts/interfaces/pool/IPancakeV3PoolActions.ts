...
export interface IPancakeV3PoolActionsInterface extends utils.Interface {
  functions: {
...
export interface IPancakeV3PoolActions extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: IPancakeV3PoolActionsInterface;
