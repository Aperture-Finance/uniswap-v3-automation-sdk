...
export function getRpcEndpoint(chainId: ApertureSupportedChainId) {
  ...
  console.log(
    `tommyzhao, ALCHEMY_API_KEY=${ALCHEMY_API_KEY}, INFURA_API_KEY=${INFURA_API_KEY}, alchemyNetworkId=${alchemyNetworkId}, infura_network_id=${infura_network_id}, rpc_url=${rpc_url}`,
  );
