...
export interface PCSV3ImmutablesInterface extends utils.Interface {
  functions: {
...
export interface PCSV3Immutables extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: PCSV3ImmutablesInterface;
