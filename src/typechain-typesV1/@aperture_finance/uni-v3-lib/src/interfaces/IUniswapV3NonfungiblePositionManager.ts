...
export interface IUniswapV3NonfungiblePositionManagerInterface
...
export interface IUniswapV3NonfungiblePositionManager extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: IUniswapV3NonfungiblePositionManagerInterface;
