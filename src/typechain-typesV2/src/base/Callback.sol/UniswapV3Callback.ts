...
export interface UniswapV3CallbackInterface extends utils.Interface {
  functions: {
...
export interface UniswapV3Callback extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: UniswapV3CallbackInterface;
