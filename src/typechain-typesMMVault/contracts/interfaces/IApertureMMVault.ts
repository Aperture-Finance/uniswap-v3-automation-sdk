...
export interface IApertureMMVaultInterface extends utils.Interface {
  functions: {
  ...
  events: {
    ...
    "LogSetManagers(address[],address[])": EventFragment;
...
export interface IApertureMMVault extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: IApertureMMVaultInterface;
  ...
  filters: {
    ...
    "LogSetManagers(address[],address[])"(
      newManagers?: null,
      statuses?: null
