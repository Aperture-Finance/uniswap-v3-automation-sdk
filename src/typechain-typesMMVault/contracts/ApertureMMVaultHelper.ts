...
export interface ApertureMMVaultHelperInterface extends utils.Interface {
  functions: {
...
export interface ApertureMMVaultHelper extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: ApertureMMVaultHelperInterface;
