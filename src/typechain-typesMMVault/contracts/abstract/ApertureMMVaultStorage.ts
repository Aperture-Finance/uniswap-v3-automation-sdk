...
export interface ApertureMMVaultStorageInterface extends utils.Interface {
  functions: {
...
export interface ApertureMMVaultStorage extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: ApertureMMVaultStorageInterface;
