...
import type {
  ApertureMMVaultStorage,
  ApertureMMVaultStorageInterface,
} from "../../../contracts/abstract/ApertureMMVaultStorage";
...
export class ApertureMMVaultStorage__factory {
  ...
  static createInterface(): ApertureMMVaultStorageInterface {
    return new utils.Interface(_abi) as ApertureMMVaultStorageInterface;
  }
  static connect(
    address: string,
