...
import type {
  IApertureMMVault,
  IApertureMMVaultInterface,
} from "../../../contracts/interfaces/IApertureMMVault";
...
export class IApertureMMVault__factory {
  ...
  static createInterface(): IApertureMMVaultInterface {
    return new utils.Interface(_abi) as IApertureMMVaultInterface;
  }
  static connect(
    address: string,
    signerOrProvider: Signer | Provider
  ): IApertureMMVault {
    return new Contract(address, _abi, signerOrProvider) as IApertureMMVault;
  }
}
