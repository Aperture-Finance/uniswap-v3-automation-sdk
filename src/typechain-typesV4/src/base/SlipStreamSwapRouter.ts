...
export interface SlipStreamSwapRouterInterface extends utils.Interface {
  functions: {
...
export interface SlipStreamSwapRouter extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: SlipStreamSwapRouterInterface;
