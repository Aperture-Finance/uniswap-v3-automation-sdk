...
export interface OptimalSwapRouterInterface extends utils.Interface {
  functions: {
...
export interface OptimalSwapRouter extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: OptimalSwapRouterInterface;
