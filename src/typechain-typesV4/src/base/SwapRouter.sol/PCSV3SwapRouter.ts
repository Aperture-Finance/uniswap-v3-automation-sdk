...
export interface PCSV3SwapRouterInterface extends utils.Interface {
  functions: {
...
export interface PCSV3SwapRouter extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: PCSV3SwapRouterInterface;
