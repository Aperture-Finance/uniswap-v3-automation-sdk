...
export interface UniV3SwapRouterInterface extends utils.Interface {
  functions: {
...
export interface UniV3SwapRouter extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: UniV3SwapRouterInterface;
