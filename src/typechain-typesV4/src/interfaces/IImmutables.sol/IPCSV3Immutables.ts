...
export interface IPCSV3ImmutablesInterface extends utils.Interface {
  functions: {
  ...
  getFunction(
    nameOrSignatureOrTopic: "WETH9" | "deployer" | "npm"
  ): FunctionFragment;
...
export interface IPCSV3Immutables extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: IPCSV3ImmutablesInterface;
