...
export interface IPancakeV3PoolStateInterface extends utils.Interface {
  functions: {
...
export interface IPancakeV3PoolState extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: IPancakeV3PoolStateInterface;
