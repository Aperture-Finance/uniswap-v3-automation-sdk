...
import { ApertureSupportedChainId, ConsoleLogger, ioc, IOCKEY_LOGGER } from '../../src';
...
async function main() {
  ...
  console.log(BigInt(1e17).toString());
  console.log(await getOkxQuote(ApertureSupportedChainId.ARBITRUM_MAINNET_CHAIN_ID, '0x82aF49447D8a07e3bd95BD0d56f35241523fBab1', '0xaf88d065e77c8cC2239327C5EDb3A432268e5831', BigInt(1e17).toString()));
}
